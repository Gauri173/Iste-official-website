...
function TeamSection({
  ...
  return (
    <section
      ...
      className={`relative w-full overflow-hidden bg-black py-28 sm:py-32 ${className}`}
    >
      {/* Ambient backdrop */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-grid-lines bg-[size:56px_56px] opacity-20 [mask-image:radial-gradient(ellipse_at_center,black_10%,transparent_70%)]"
      />
      <div
        aria-hidden="true"
