...
const defaultSections = [
  ...
  },
  {
    ...
    badge: "Leadership",
    title: "The Team",
    description: "Meet the visionary faculty, executive board members, and core team driving innovation and excellence at ISTE TIET.",
    align: "center",
    isAboutSection: true,
    actions: [
      { label: "Explore Team Directory", variant: "primary", href: "/team" }
    ]
  },
  {
    id: "sponsors",
    badge: "Partnerships",
    title: "Our Sponsors",
    description: "Supported by industry leaders, tech partners, and organizations fueling our mission to empower the next generation of engineers.",
    align: "center",
    actions: [
      { label: "View All Sponsors", variant: "primary", href: "/sponsors" }
    ]
  }
];
...
export default function HomeGauri({ sections = defaultSections, className }) {
  ...
  return (
    ...
    <div
      ...
      className={cn("relative w-full overflow-x-hidden min-h-screen bg-black text-gray-200 antialiased selection:bg-[#00F0FF]/20", className)}
    >
      ...
      <div className="relative z-10 w-full">
        {sections.map((section, index) => (
          ...
          >
            <div className={cn("w-full space-y-8", section.align === 'center' ? "max-w-4xl mx-auto" : "max-w-4xl")}>

              {/* HERO SPECIFIC CUSTOM LAYOUT */}
              {section.id === "hero" ? (
                <div className="w-full flex flex-col items-start space-y-5 text-left select-none">
                  <div className="relative inline-block">
                    <h1 className="font-display text-4xl sm:text-6xl md:text-[4.4rem] font-extrabold tracking-tight leading-[1.02] text-white uppercase flex flex-col">
                      <span className="text-white">Indian</span>
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00F0FF] via-[#00B4D8] to-[#0B3D91]">Society for</span>
                      <span className="text-white">Technical</span>
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00B4D8] via-[#041C4A] to-[#0B3D91]">Education</span>
                    </h1>
                  ...
                  <div className="pt-4">
                    <h2 className="font-display text-lg sm:text-2xl font-bold tracking-[0.12em] uppercase bg-clip-text text-transparent bg-gradient-to-r from-[#00F0FF] via-[#00B4D8] to-[#0B3D91]">
                ...
                <>
                  {section.badge && (
                    <span className="font-display inline-block px-3.5 py-1 text-[10px] font-bold tracking-widest uppercase bg-[#0D1524] text-[#00F0FF] rounded-full border border-[#00F0FF]/20 shadow-sm">
                      {section.badge}
                    </span>
                  )}
                  {section.subtitle && (
